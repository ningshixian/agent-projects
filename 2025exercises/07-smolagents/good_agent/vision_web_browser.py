...
def close_popups() -> str:
    ...
    if driver is not None:
        ...
        return "Closed popups successfully."
    else:
        return "Error: WebDriver not initialized"
...
def main():
    ...
    model = load_model(
        ...
        model_id="gpt-4o", 
        api_key="sk-rnWXmmzGs7m7h2XBA9470c4d86D74e9e8f0518E6F22d9805", 
        api_base="https://api.laozhang.ai/v1"
    )   # 需要用一个多模态 LLM（如 GPT-4o），否则报错
    ...
    if driver is not None:
        agent.python_executor.send_variables({"driver": driver})
